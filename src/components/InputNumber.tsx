...
export default function InputNumber({ id, name, handleChange }:Props) {
    return (
        <NumberInput name={name} onChange={(value) => handleChange(parseInt(value), parseInt(id))} pt="0" maxW={50} focusBorderColor="purple.500" variant="filled" ml="auto" min={0} max={9}>
